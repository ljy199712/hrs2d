...
class Attention_Module(nn.Module):
    ...
    def forward(self, high_features, low_features):
        ...
        # features1 = self.ca(features)
        # # self.sim = simam_module(features)
        features1 = self.sim(features)
        # features1 = self.ca(features)
        # features = self.sa(features)
        #features = self.cs(features)
        
        return self.relu(self.conv_se(features1))
