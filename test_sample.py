...
def test_simple(args):
    ...
    with torch.no_grad():
        for idx, image_path in enumerate(paths):
            ...
            name_dest_npy = os.path.join(output_directory, "{}_disp_{}.npy".format(output_name,idx + 1))
            ...
            name_dest_im = os.path.join('results',"{}_disp_{}.jpeg".format(image_name,idx + 1))
            ...
            name_grey_depth = os.path.join('results',"{}_grey_disp_{}.png".format(image_name,idx + 1))
            name_corped_rgb = os.path.join('results',"{}_rgb_{}.png".format(image_name,idx + 1))
