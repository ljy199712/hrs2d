...
class Trainer:
    def __init__(self, options):
        ...
        val_dataset = datasets.KITTIRAWDataset( 
            '/home/ljy/KITTI', val_filenames, self.opt.height, self.opt.width,
    ...
    def robust_l1(self, pred, target):
        ...
        return torch.sqrt((torch.pow(target - pred, 2) + eps ** 2)) #*0.85 + l1_loss*0.15
    #######################
